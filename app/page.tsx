      ...
      <section className="bg-gray-50 border-t border-gray-100 px-6 py-16">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 text-center">
          <div className="flex flex-col items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-[#CC0066]/10 flex items-center justify-center">
              <svg className="w-6 h-6 text-[#CC0066]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
